# Personal Finance App (Spendo)

## Project Documentation

All product decisions, requirements, and specifications must be documented in the `docs/` folder. Before implementing features, check these docs for context. After making product decisions, update the relevant doc file.
