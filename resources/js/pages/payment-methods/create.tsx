...
import type { BreadcrumbItem, Account, PaymentMethodType } from '@/types';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nuevo Método', href: '/payment-methods/create' },
];
...
export default function PaymentMethodCreate({ accounts }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        payment_due_day: null as number | null,
        is_active: true,
    });
                                ...
                                {requiresLinkedAccount && (
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-muted-foreground text-xs">
                                            Los movimientos se descontarán de esta cuenta
                                        </p>
