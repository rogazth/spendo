...
import type { BreadcrumbItem, Account, Category, PaymentMethod, Transaction, TransactionType } from '@/types';
...
export default function TransactionEdit({ transaction, accounts, categories, paymentMethods }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Dashboard', href: '/dashboard' },
        { title: 'Transacciones', href: '/transactions' },
        { title: 'Editar', href: `/transactions/${transaction.uuid}/edit` },
    ];
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        put(`/transactions/${transaction.uuid}`);
    };
