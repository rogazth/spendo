    ...
    public function handle(Request $request): array
    {
        ...
        return [
            Response::text(<<<PROMPT
                ...
                1. **Check existing setup**: Call GetAccountsTool, GetPaymentMethodsTool, and GetCategoriesTool to see what already exists.
                ...
                3. **Create missing entities**: If any accounts, payment methods, or categories are missing, ask the user what to create and use the appropriate Create tools.
